        ...
        <div className='flex' >
            ...
            <div className='w-1/4 block bg-blue-900 border rounded-xl text-white relative'>
                ...
                <div className='flex m-auto border-b border-r w-3/4 rounded-3xl h-6 bg-white mt-10'>
                    ...
                    <span className='text-sm lg:ml-5 lg:text-center text-black sm:ml-0 '>Cours</span>
                ...
                <Link to='/video' >
                <div className='flex m-auto border border-white  w-3/4 rounded-3xl h-6 bg-sky-800 mt-6 mb-28'>
                    <div className='ml-1 border-4 border-white  rounded-full w-6 h-6 bg-white '>
                    </div>
                    <span className='text-sm lg:ml-5 text-center text-white mm:ml-0 '>Video</span>
            ...
            <div className='m-3 block text-sm w-3/4 relative'>
                ...
                <div className='flex mt-10 w-3/4 m-auto '>
                    <div className=' bg-blue-900 text-white w-24 h-32  border rounded-xl  mr-7  '><img className='w-10 m-auto mt-2' src='' alt="" /> <h2 className='mt-4 text-center text-lg'>Video 1 </h2></div>
                    <div className=' bg-blue-900 text-white w-24 h-32  border rounded-xl  mr-7  '><img className='w-10 m-auto mt-2' src='' alt="" /> <h2 className='mt-4 text-center text-lg'>Video 2 </h2></div>
                    <div className=' bg-blue-900 text-white w-24 h-32 border rounded-xl   '><img className='w-10 m-auto mt-2' src='' alt="" /> <h2 className='mt-4   text-center text-lg'>Video 3 </h2></div>
